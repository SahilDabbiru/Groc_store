...
#import "PersonalCareViewController.h"

@interface PersonalCareViewController ()

@end

@implementation PersonalCareViewController
...
- (void)viewDidLoad
{
    ...
    EdiblesDataList= [[NSMutableArray alloc] initWithObjects:@"CLEANING SOAPS/GELS",
                      @"DEO/PURFUMES", @"FACIAL CARE",@"HAIR CARE",@"MOISTURIZERS",@"ORAL CARE",@"TALUM POWDER",@"SHAVING AIDS",@"OTHERS",@"HEALTH CARE",nil];
}
